---
title: "Population Ageing and AI Attitudes: Simplified Multi-level Analysis of 2024 Data"
author: "Analysis"
date: "`r Sys.Date()`"
output: 
  html_document:
...
data <- data %>%
  ...
  mutate(
    ...
    robot_good_society = case_when(
      qb6_2 == 1 ~ 1,             # Totally agree
      qb6_2 == 2 ~ 2,             # Tend to agree
      qb6_2 == 3 ~ 3,             # Tend to disagree
      qb6_2 == 4 ~ 4,             # Totally disagree
      qb6_2 == 5 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    
    robot_steal_jobs = case_when(
      qb6_5 == 1 ~ 1,             # Totally agree
      qb6_5 == 2 ~ 2,             # Tend to agree
      qb6_5 == 3 ~ 3,             # Tend to disagree
      qb6_5 == 4 ~ 4,             # Totally disagree
      qb6_5 == 5 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    
    robot_job_losses = case_when(
      qb6_1 == 1 ~ 1,             # Totally agree (job losses exceed creation)
      qb6_1 == 2 ~ 2,             # Tend to agree
      qb6_1 == 3 ~ 3,             # Tend to disagree (job creation exceeds losses)
      qb6_1 == 4 ~ 4,             # Totally disagree
      qb6_1 == 5 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    
    robot_careful_mgmt = case_when(
      qb6_3 == 1 ~ 1,             # Totally agree
      qb6_3 == 2 ~ 2,             # Tend to agree
      qb6_3 == 3 ~ 3,             # Tend to disagree
      qb6_3 == 4 ~ 4,             # Totally disagree
      qb6_3 == 5 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    )
  ) %>%
...
save_table_png(missing_pct, "2024_simplified_missing_data", "Missing Data Summary")
```
  ...
  formatted_table <- model_summary %>%
    ...
    mutate(
      ...
      term = case_when(
        ...
        term == "fertility_rate_2023" ~ "Total Fertility Rate",
        term == "gdp_per_capita_2023_standardised" ~ "GDP per Capita (Standardised)",
        term == "ihdi_2023" ~ "IHDI",
        TRUE ~ term
      )
    ) %>%
...
save_equation_png(equation_text, variables_text, "2024_total_fertility_rate_model")

# Model 1: Robot/AI Good for Society
case1_model1 <- lmer(robot_good_society ~ d11 + gender_binary + education_years + community_size + 
                     political_lr + digital_skills_avg + fertility_rate_2023 + 
                     gdp_per_capita_2023_standardised + ihdi_2023 +
...
format_model_table(case1_model1, "Total Fertility Rate Model: Robot/AI Good for Society", 
                  "2024_case1_model1_good_society")
...
format_model_table(case1_model4, "Total Fertility Rate Model: Robot/AI Careful Management", 
                  "2024_case1_model4_careful_mgmt")
```
  ...
  formatted_table <- model_summary %>%
    ...
    mutate(
      ...
      term = case_when(
        ...
        term == "political_lr" ~ "Political Orientation",
        term == "digital_skills_avg" ~ "Digital Skills (Average)",
        term == "pop_65_above_2023" ~ "Population Ageing",
        term == "gdp_per_capita_2023_standardised" ~ "GDP per Capita (Standardised)",
        term == "ihdi_2023" ~ "IHDI",
        TRUE ~ term
      )
...
save_equation_png(equation_text, variables_text, "2024_ageing_population_model")

# Model 1: Robot/AI Good for Society
case2_model1 <- lmer(robot_good_society ~ d11 + gender_binary + education_years + community_size + 
                     political_lr + digital_skills_avg + pop_65_above_2023 + 
                     gdp_per_capita_2023_standardised + ihdi_2023 +
...
format_model_table_case2(case2_model1, "Ageing Population Model: Robot/AI Good for Society", 
                        "2024_case2_model1_good_society")
...
format_model_table_case2(case2_model4, "Ageing Population Model: Robot/AI Careful Management", 
                        "2024_case2_model4_careful_mgmt")
```
...
save_equation_png(equation_text, variables_text, "2024_demographic_transition_model")
...
format_model_table_case3(case3_model1, "Demographic Transition Model: Robot/AI Good for Society", 
                        "2024_case3_model1_good_society")
...
format_model_table_case3(case3_model4, "Demographic Transition Model: Robot/AI Careful Management", 
                        "2024_case3_model4_careful_mgmt")
```
...
if(nrow(all_demographic_effects) > 0) {
  ...
  cat("### Summary of Demographic Effects Across All Models (2024)\n")
  print(kable(all_demographic_effects, 
              caption = "Demographic Effects Summary: 2024 Data"))
  
  # Save summary table
  save_table_png(all_demographic_effects, "2024_demographic_effects_summary")
  ...
  save_table_png(sig_summary, "2024_significant_effects_summary")
...
This simplified analysis examined the relationships between demographic factors and AI attitudes using 2024 Eurobarometer data with reduced model complexity:
...
4. **Country Consolidation**: Germany (DE-W + DE-E) data combined, resulting in 27 countries (United Kingdom not included in 2024 data)
