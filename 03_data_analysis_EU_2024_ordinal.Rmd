---
title: "Population Ageing and AI Attitudes: Simplified Ordinal Multilevel Analysis of 2024 Data"
author: "Analysis"
date: "`r Sys.Date()`"
output: 
  html_document:
...
data <- read.csv("integrated_data_Eurobarometer2024.csv", stringsAsFactors = FALSE)
...
data <- data %>%
  ...
  mutate(
    ...
    digital_skills_daily = case_when(
      qb2_1 == 1 ~ 4,             # Totally agree (high skills)
      qb2_1 == 2 ~ 3,             # Tend to agree
      qb2_1 == 3 ~ 2,             # Tend to disagree
      qb2_1 == 4 ~ 1,             # Totally disagree (low skills)
      qb2_1 == 5 ~ NA_real_,      # Not applicable
      qb2_1 == 6 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    
    digital_skills_job = case_when(
      qb2_2 == 1 ~ 4,             # Totally agree (high skills)
      qb2_2 == 2 ~ 3,             # Tend to agree
      qb2_2 == 3 ~ 2,             # Tend to disagree
      qb2_2 == 4 ~ 1,             # Totally disagree (low skills)
      qb2_2 == 5 ~ NA_real_,      # Not applicable
      qb2_2 == 6 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    
    digital_skills_future = case_when(
      qb2_3 == 1 ~ 4,             # Totally agree (high skills)
      qb2_3 == 2 ~ 3,             # Tend to agree
      qb2_3 == 3 ~ 2,             # Tend to disagree
      qb2_3 == 4 ~ 1,             # Totally disagree (low skills)
      qb2_3 == 5 ~ NA_real_,      # Not applicable
      qb2_3 == 6 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    
    digital_skills_learning = case_when(
      qb2_4 == 1 ~ 4,             # Totally agree (high skills)
      qb2_4 == 2 ~ 3,             # Tend to agree
      qb2_4 == 3 ~ 2,             # Tend to disagree
      qb2_4 == 4 ~ 1,             # Totally disagree (low skills)
      qb2_4 == 5 ~ NA_real_,      # Not applicable
      qb2_4 == 6 ~ NA_real_,      # Don't know
      TRUE ~ NA_real_
    ),
    ...
    robot_good_society = case_when(
      ...
      qb6_2 == 5 ~ NA_character_,      # Don't know
      TRUE ~ NA_character_
    ),
    
    robot_steal_jobs = case_when(
      qb6_5 == 1 ~ "Totally agree",    # Robots take jobs
      qb6_5 == 2 ~ "Tend to agree",
      qb6_5 == 3 ~ "Tend to disagree", # Robots don't take jobs
      qb6_5 == 4 ~ "Totally disagree",
      qb6_5 == 5 ~ NA_character_,      # Don't know
      TRUE ~ NA_character_
    ),
    
    robot_job_losses = case_when(
      qb6_1 == 1 ~ "Totally agree",    # Job losses exceed creation
      qb6_1 == 2 ~ "Tend to agree", 
      qb6_1 == 3 ~ "Tend to disagree", # Job creation exceeds losses
      qb6_1 == 4 ~ "Totally disagree",
      qb6_1 == 5 ~ NA_character_,      # Don't know
      TRUE ~ NA_character_
    ),
    ...
    robot_careful_mgmt = case_when(
      ...
      qb6_3 == 5 ~ NA_character_,      # Don't know
      TRUE ~ NA_character_
    )
  ) %>%
...
save_table(missing_pct, "2024_simplified_ordinal_missing_data", "Missing Data Summary")
```
...
format_ordinal_table <- function(model, caption, table_filename) {
  ...
  tryCatch({
    ...
    results_table$Predictor <- case_when(
      ...
      results_table$Predictor == "fertility_rate_2023" ~ "Total Fertility Rate",
      results_table$Predictor == "gdp_per_capita_2023_standardised" ~ "GDP per Capita (Standardised)",
      results_table$Predictor == "ihdi_2023" ~ "IHDI",
...
model1_model1 <- safe_ordinal_fit(
  "robot_good_society ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + fertility_rate_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model1_good_society,
...
if(!is.null(model1_model1)) {
  format_ordinal_table(model1_model1, "Total Fertility Rate Model: Robot/AI Good for Society", 
                      "2024_model1_ordinal_model1_good_society")
}

# Model 1.2: Robot/AI Steal Jobs
model1_model2 <- safe_ordinal_fit(
  "robot_steal_jobs ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + fertility_rate_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model1_steal_jobs,
...
if(!is.null(model1_model2)) {
  format_ordinal_table(model1_model2, "Total Fertility Rate Model: Robot/AI Steal Jobs", 
                      "2024_model1_ordinal_model2_steal_jobs")
}

# Model 1.3: Robot/AI Job Losses
model1_model3 <- safe_ordinal_fit(
  "robot_job_losses ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + fertility_rate_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model1_job_losses,
...
if(!is.null(model1_model3)) {
  format_ordinal_table(model1_model3, "Total Fertility Rate Model: Robot/AI Job Losses", 
                      "2024_model1_ordinal_model3_job_losses")
}

# Model 1.4: Robot/AI Careful Management
model1_model4 <- safe_ordinal_fit(
  "robot_careful_mgmt ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + fertility_rate_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model1_careful_mgmt,
...
if(!is.null(model1_model4)) {
  format_ordinal_table(model1_model4, "Total Fertility Rate Model: Robot/AI Careful Management", 
                      "2024_model1_ordinal_model4_careful_mgmt")
}
```
...
model2_model1 <- safe_ordinal_fit(
  "robot_good_society ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + pop_65_above_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model2_good_society,
...
format_ordinal_table_model2 <- function(model, caption, table_filename) {
  ...
  tryCatch({
    ...
    results_table$Predictor <- case_when(
      ...
      results_table$Predictor == "political_lr" ~ "Political Orientation",
      results_table$Predictor == "digital_skills_avg" ~ "Digital Skills (Average)",
      results_table$Predictor == "pop_65_above_2023" ~ "Population Aged 65+",
      results_table$Predictor == "gdp_per_capita_2023_standardised" ~ "GDP per Capita (Standardised)",
      results_table$Predictor == "ihdi_2023" ~ "IHDI",
      TRUE ~ results_table$Predictor
    )
...
if(!is.null(model2_model1)) {
  format_ordinal_table_model2(model2_model1, "Ageing Population Model: Robot/AI Good for Society", 
                      "2024_model2_ordinal_model1_good_society")
}

# Model 2.2: Robot/AI Steal Jobs
model2_model2 <- safe_ordinal_fit(
  "robot_steal_jobs ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + pop_65_above_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model2_steal_jobs,
...
if(!is.null(model2_model2)) {
  format_ordinal_table_model2(model2_model2, "Ageing Population Model: Robot/AI Steal Jobs", 
                      "2024_model2_ordinal_model2_steal_jobs")
}

# Model 2.3: Robot/AI Job Losses
model2_model3 <- safe_ordinal_fit(
  "robot_job_losses ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + pop_65_above_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model2_job_losses,
...
if(!is.null(model2_model3)) {
  format_ordinal_table_model2(model2_model3, "Ageing Population Model: Robot/AI Job Losses", 
                      "2024_model2_ordinal_model3_job_losses")
}

# Model 2.4: Robot/AI Careful Management
model2_model4 <- safe_ordinal_fit(
  "robot_careful_mgmt ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + pop_65_above_2023 + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model2_careful_mgmt,
...
if(!is.null(model2_model4)) {
  format_ordinal_table_model2(model2_model4, "Ageing Population Model: Robot/AI Careful Management", 
                      "2024_model2_ordinal_model4_careful_mgmt")
}
```
...
prepare_model3_data <- function(data, outcome_var) {
  data %>%
    ...
    filter(!is.na(d11), !is.na(gender_binary), !is.na(education_years),
           !is.na(community_size), !is.na(political_lr), !is.na(digital_skills_avg),
           !is.na(ageing_fertility_ratio), !is.na(gdp_per_capita_2023_standardised), !is.na(ihdi_2023)) %>%
    # Remove countries with too few observations to avoid convergence issues
    group_by(isocntry) %>%
    filter(n() >= 20) %>%  # Minimum 20 observations per country
    ungroup() %>%
...
model3_model1 <- safe_ordinal_fit(
  "robot_good_society ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + ageing_fertility_ratio + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model3_good_society,
...
if(!is.null(model3_model1)) {
  format_ordinal_table_model3(model3_model1, "Demographic Transition Model: Robot/AI Good for Society", 
                      "2024_model3_ordinal_model1_good_society")
}

# Model 3.2: Robot/AI Steal Jobs
model3_model2 <- safe_ordinal_fit(
  "robot_steal_jobs ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + ageing_fertility_ratio + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model3_steal_jobs,
...
if(!is.null(model3_model2)) {
  format_ordinal_table_model3(model3_model2, "Demographic Transition Model: Robot/AI Steal Jobs", 
                      "2024_model3_ordinal_model2_steal_jobs")
}

# Model 3.3: Robot/AI Job Losses
model3_model3 <- safe_ordinal_fit(
  "robot_job_losses ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + ageing_fertility_ratio + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model3_job_losses,
...
if(!is.null(model3_model3)) {
  format_ordinal_table_model3(model3_model3, "Demographic Transition Model: Robot/AI Job Losses", 
                      "2024_model3_ordinal_model3_job_losses")
}

# Model 3.4: Robot/AI Careful Management
model3_model4 <- safe_ordinal_fit(
  "robot_careful_mgmt ~ d11 + gender_binary + education_years + community_size + political_lr + digital_skills_avg + ageing_fertility_ratio + gdp_per_capita_2023_standardised + ihdi_2023 + (1 | isocntry)",
  model3_careful_mgmt,
...
if(!is.null(model3_model4)) {
  format_ordinal_table_model3(model3_model4, "Demographic Transition Model: Robot/AI Careful Management", 
                      "2024_model3_ordinal_model4_careful_mgmt")
}
```
...
if(nrow(all_demographic_effects) > 0) {
  ...
  cat("### Summary of Demographic Effects Across All Models (2024 - Ordinal)\n")
  print(kable(final_results, 
              caption = "Demographic Effects Summary: 2024 Ordinal Data"))
  
  # Save summary table
  save_table(final_results, "2024_ordinal_demographic_effects_summary", 
...
This simplified ordinal regression analysis examined the relationships between demographic factors and AI attitudes using 2024 Eurobarometer data across 27 European countries with reduced model complexity:

### Key Methodological Changes:
1. **Simplified Variables**: Removed age-squared term, combined gender categories (including non-binary), and averaged digital skills
...
- **Non-binary Gender Option**: Accommodated expanded gender categories in 2024 survey
- **Updated Variable References**: Used 2024-specific variable codes (qb6_* for outcomes, qb2_* for digital skills)
- **Contemporary Country Data**: Utilised 2023 country-level indicators for population ageing, fertility, GDP, and human development

The simplified ordinal approach allows for clearer interpretation of specific demographic influences whilst preserving the categorical nature of attitude responses and maintaining statistical power through reduced model complexity. Comparison with 2017 results reveals temporal changes in how demographic factors influence AI attitudes.